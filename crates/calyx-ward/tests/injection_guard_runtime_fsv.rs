...
//!
//! Manual aiwonder GPU fixture (real model + real corpus, no mocks):
//!   CALYX_INJECTION_GUARD_FSV_DIR=/home/croyse/calyx/data/fsv-issue697-... \
...
#[test]
#[ignore = "manual aiwonder GPU fixture; set CALYX_INJECTION_GUARD_FSV_DIR"]
